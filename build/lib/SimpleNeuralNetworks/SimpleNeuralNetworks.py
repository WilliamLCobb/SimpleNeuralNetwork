...
class StaticNetwork(object):
    ...
    def saveNetwork(self, fp):
        pickle.dump([self.biases, self.weights], open(fp, 'w'))

    def loadNetwork(self, fp):
    ...
    def backPropagation(self, x, y):
        ...
        # backward pass
        delta = self.cost_derivative(activations[-1], y) * sigmoidPrime_vec(zs[-1])  # http://www.holehouse.org/mlclass/09_Neural_Networks_Learning.html
